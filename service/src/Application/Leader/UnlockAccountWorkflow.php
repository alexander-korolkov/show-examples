...
class UnlockAccountWorkflow extends BaseWorkflow
{
    const TYPE = "leader.unlock_account";
    ...
    /**
     * UnlockAccountWorkflow constructor.
    ...
    public function __construct(
        ...
        parent::__construct(
            $this->activities([
                'tellPluginToUnlockAccount',
            ])
        );
    }

    public function tellPluginToUnlockAccount(Activity $activity): void
    {
